...
# trained for 360 epochs with the PAR policy objective:
#     0.5 * (dr * (A - (fELBO - oELBO))^2)
# Advantage-regression: regress the logratio onto the advantage.
#
