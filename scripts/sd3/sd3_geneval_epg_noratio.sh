#!/bin/bash
#SBATCH --job-name=sd3_gen_epg_nr
...
# trained for 360 epochs with the EPG_NORATIO policy objective:
#     -(A * fELBO)
# EPG with the detached importance ratio dropped (ours-only variant).
#
