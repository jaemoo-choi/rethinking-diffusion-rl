#!/bin/bash
#SBATCH --job-name=sd3_gen_pepg_nr
...
# trained for 360 epochs with the PEPG_NORATIO policy objective:
#     -((A - dlogr) * fELBO)
# PEPG with the detached importance ratio dropped (ours-only variant).
#
